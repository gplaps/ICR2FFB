...
void TelemetryDisplay::DisplayTelemetry(const FFBConfig& config) const
{
    ...
    if (config.GetBool(L"other", L"telemetry"))
    {
        // Raw data section
        ...
        ss.str(L"");
        ss.clear();
        ss << L"Rotation Raw: " << std::setw(8) << displayData.raw.rotation_raw << L" deg";
        std::wcout << padLine(ss.str()) << L"\n";
        ...
        ss.str(L""); ss.clear();
        ss << L"TireLoad LF: " << std::setw(10) << displayData.raw.tireload_lf;
        std::wcout << padLine(ss.str()) << L"\n";

        ss.str(L""); ss.clear();
        ss << L"TireLoad RF: " << std::setw(10) << displayData.raw.tireload_rf;
        std::wcout << padLine(ss.str()) << L"\n";

        ss.str(L""); ss.clear();
        ss << L"TireLoad LR: " << std::setw(10) << displayData.raw.tireload_lr;
        std::wcout << padLine(ss.str()) << L"\n";

        ss.str(L""); ss.clear();
        ss << L"TireLoad RR: " << std::setw(10) << displayData.raw.tireload_rr;
        std::wcout << padLine(ss.str()) << L"\n";

        ss.str(L""); ss.clear();
        ss << L"TireLoad LAT LF: " << std::setw(10) << displayData.raw.tiremaglat_lf;
        std::wcout << padLine(ss.str()) << L"\n";

        ss.str(L""); ss.clear();
        ss << L"TireLoad LAT RF: " << std::setw(10) << displayData.raw.tiremaglat_rf;
        std::wcout << padLine(ss.str()) << L"\n";

        ss.str(L""); ss.clear();
        ss << L"TireLoad LAT LR: " << std::setw(10) << displayData.raw.tiremaglat_lr;
        std::wcout << padLine(ss.str()) << L"\n";

        ss.str(L""); ss.clear();
        ss << L"TireLoad LAT RR: " << std::setw(10) << displayData.raw.tiremaglat_rr;
        std::wcout << padLine(ss.str()) << L"\n";

        ss.str(L""); ss.clear();
        ss << L"TireLoad LONG LF: " << std::setw(10) << displayData.raw.tiremaglong_lf;
        std::wcout << padLine(ss.str()) << L"\n";

        ss.str(L""); ss.clear();
        ss << L"TireLoad LONG RF: " << std::setw(10) << displayData.raw.tiremaglong_rf;
        std::wcout << padLine(ss.str()) << L"\n";

        ss.str(L""); ss.clear();
        ss << L"TireLoad LONG LR: " << std::setw(10) << displayData.raw.tiremaglong_lr;
        std::wcout << padLine(ss.str()) << L"\n";

        ss.str(L""); ss.clear();
        ss << L"TireLoad LONG RR: " << std::setw(10) << displayData.raw.tiremaglong_rr;
        std::wcout << padLine(ss.str()) << L"\n";
